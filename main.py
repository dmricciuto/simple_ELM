...
model.run_selm(use_nn=True, prefix='default', seasonal_rootalloc=False, spinup_cycles=2,nfroot_orders=1)
...
model.run_selm(use_nn=True, prefix='root_phen', seasonal_rootalloc=True, spinup_cycles=2, nfroot_orders=1)
